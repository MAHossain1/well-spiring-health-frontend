...
const ProfileUpdateModal = ({ open, setOpen, id }: TProps) => {
  ...
  return (
    <WSFullScreenModal open={open} setOpen={setOpen} title="Update Profile">
      <WSForm
      ...
      >
        <Grid container spacing={2} sx={{ my: 5 }}>
          <Grid item xs={12} sm={12} md={4}>
            <WSInput name="name" label="Name" sx={{ mb: 2 }} fullWidth />
          </Grid>
          <Grid item xs={12} sm={12} md={4}>
            <WSInput
              name="email"
          ...
          <Grid item xs={12} sm={12} md={4}>
            <WSInput name="address" label="Address" sx={{ mb: 2 }} fullWidth />
          </Grid>
          <Grid item xs={12} sm={12} md={4}>
            <WSInput
